...
public class PaisOperaciones {
    ...
    public int agregar(Pais pais) {  
        int r=0;
        String sql="insert into pais(codigoPais,nombrePais,continentePais,poblacionPais, tipoGobierno,region,superficie,añoIndependencia,expectativaVida,pnb,jefeEstado,ciudadCapital,idiomaPais)values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            ...
            ps.setInt(8, pais.getAñoIndependencia());
